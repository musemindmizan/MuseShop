<x-admin-layout>
                        ...
                        @forelse ($brands as $brand)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div
                                        ...
                                        <img src="{{ asset('uploads/brands') }}/{{ $brand->logo }}"
                                            class="max-w-[30px] max-h-[30px] object-contain" alt="Brand Logo"
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @else
                                        <span
                                            class="bg-red-100 text-red-700 px-2.5 py-1 rounded-full text-xs font-semibold">Deactive</span>
                                    @endif
                                </td>
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Are you sure you want to delete <strong
                                            id="delete-brand-name" class="text-gray-800">this brand</strong>? All of its
    ...
    <form id="delete-brand-form" method="POST" class="hidden">
        @csrf
    </form>
    ...
    <script>
        ...
        const deleteForm = document.getElementById('delete-brand-form');
        const deleteUrlTemplate = "{{ route('admin.brand.delete', ':id') }}";
        ...
        confirmBtn.addEventListener('click', function() {
            if (brandIdToDelete) {
                deleteForm.action = deleteUrlTemplate.replace(':id', brandIdToDelete);
                deleteForm.submit();
            }
        });
    </script>
