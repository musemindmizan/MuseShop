                    ...
                    <div class="flex flex-col md:flex-row gap-8 items-start pt-4">
                        @if ($brand->logo)
                            <div class="w-full md:w-1/3">
                                ...
                                <div
                                    class="h-40 w-full border rounded-lg bg-white flex items-center justify-center p-4">
                                    <img src="{{ asset('uploads/brands') }}/{{$brand->logo}}" class="max-h-full max-w-full object-contain"
                                        alt="Brand Logo">
                                </div>
                            </div>
                        @endif
