            ...
            <div class="flex justify-between items-center">
                ...
                <div class="w-1/4 flex justify-end items-center space-x-6">
                    ...
                    <a href="{{route('cart.index')}}" class="text-2xl hover:text-primary relative">
                        ...
                        @if ($cartCount > 0)
                            <span
                                class="absolute -top-2 -right-2 bg-primary text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">{{ $cartCount }}</span>
                        @endif
                    </a>
                    ...
                    <div class="relative group">
                        ...
                        <ul
                            ...
                            @else
                                <li><a href='{{ Auth::user()->role === 'admin' ? route('admin.index') : route('user.index') }}' class="block px-4 py-2 hover:bg-gray-100 text-sm">My Account</a></li>
                                <li>
                                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('form-logout').submit()" class="block px-4 py-2 hover:bg-gray-100 text-sm">Sign Out</a>
                                    <form action="{{ route('logout') }}" method="POST" id="form-logout" class="hidden">
                                        @csrf
                                    </form>
                                </li>
                            @endguest
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex items-center space-x-5">
                    ...
                    <a href="{{route('cart.index')}}" class="text-xl hover:text-primary relative">
                        ...
                        @if ($cartCount > 0)
                            <span
                                class="absolute -top-2 -right-2 bg-primary text-white text-[10px] rounded-full w-4 h-4 flex items-center justify-center">{{ $cartCount }}</span>
                        @endif
                    </a>
